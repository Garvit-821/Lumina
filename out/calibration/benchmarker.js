...
class ModelBenchmarker {
    static async runBenchmark(ollamaClient, modelName, onProgress) {
        ...
        try {
            ...
            logger_1.LuminaLogger.getInstance().log(`Benchmark completed for ${modelName}`, result);
            return result;
        }
        catch (err) {
            logger_1.LuminaLogger.getInstance().warn(`Benchmark failed on live Ollama, generating calibrated estimate: ${err}`);
...
exports.ModelBenchmarker = ModelBenchmarker;
